...
RunAction "WIC", oneIteration
	...
	wait 2
     ...
     While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Seleccionar Productos").JavaEdit("TextFieldNative$1").Exist=False
     	wait 1
     Wend
     wait 3
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Seleccionar Productos").JavaEdit("TextFieldNative$1").Set DataTable("e_ID_Servicio",dtLocalSheet)
	wait 3
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Seleccionar Productos").JavaList("ComboBoxNative$1").Exist=False
		wait 1
	Wend
	wait 3
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Seleccionar Productos").JavaList("ComboBoxNative$1").Select "Asignado"
...
wait 1
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").Exist=True Then
		varlog = JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").JavaTable("SearchJTable").GetCellData(1,1)

			wait 1
			varlog2= Replace(varlog, "<html>","") 
			varlog2= Replace(varlog, "<html>","")
			varlog = Instr(1,varlog,"No se puede hacer cambio de titularidad porque existe una orden pendiente en al menos uno de los productos seleccionados.")
			wait 1
			If (varlog = "7") Then
			DataTable("s_Resultado", dtLocalSheet) = "Fallido"
			...
			imagenToWord "Fallo en realizar la migración",RutaEvidencias() & "MensajeValidacion.png"
			JavaWindow("Ejecutivo de interacción").JavaDialog("Mensajes de validación").JavaButton("Cerrar").Click
			wait 3
			JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Seleccionar Productos").JavaButton("Cancelar acción de orden").Click
			...
			While JavaWindow("Ejecutivo de interacción").JavaDialog("Seleccionar Productos").JavaTable("Acciones de orden que").Exist=False
				wait 1
			Wend
			wait 2		
			JavaWindow("Ejecutivo de interacción").JavaDialog("Seleccionar Productos").JavaButton("Aceptar").Click

			While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Orden 478446254A").JavaEdit("TextAreaNative$1").Exist=False
				wait 1
			Wend
			wait 2
...
'	If 	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Configuración y detalles").JavaTable("SearchJTable").Exist=True Then
'		
'		 Dim Iterator, filas,j
'		filas= JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Configuración y detalles").JavaTable("SearchJTable").GetROProperty("rows")
'		 For Iterator = 0 To filas-1 step 1 
'		 j =JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Configuración y detalles").JavaTable("SearchJTable").GetCellData("#"&Iterator, "#1")
'	    If j ="Cliente no elegible"Then
'	
'		 
'			End if	
'		Next
...
wait 1	
	...
	tiempo=0
		Do
			...
			End If
			wait 1
		Loop While Not JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTable("Mostrar atributos:").Exist
		wait 1
	...
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaStaticText("Mostrando 1-6 de 20 ofertas").Exist = False
		wait 1
	Wend
	JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaEdit("TextFieldNative$1").Set DataTable("e_Plan",dtLocalSheet)
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaButton("Buscar").Click
	wait 5
	
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaDialog("Mensaje").JavaStaticText("No existen ofertas elegibles").Exist=True Then
		wait 2
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "ofertano.png", True
		imagenToWord "No existe oferta",RutaEvidencias() & "ofertano.png"
		DataTable("s_Resultado","CambioTitularidad&CambioPlan") ="Fallido"
		DataTable("s_Detalle","CambioTitularidad&CambioPlan") ="No existe oferta"
		Reporter.ReportEvent micFail, DataTable("s_Resultado","CambioTitularidad&CambioPlan"), DataTable("s_Detalle","CambioTitularidad&CambioPlan")
		
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaDialog("Mensaje").JavaButton("OK").Click

		wait 2
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaButton("Cerrar").Click
		wait 2
		...
		wait 1
		JavaWindow("Ejecutivo de interacción").JavaDialog("Seleccionar una opción").JavaButton("Sí").Click
		While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaTable("Acciones de orden que").Exist=False
			wait 1
		Wend
		wait 1		
		JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración_2").JavaButton("Aceptar").Click
		While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Orden 478446254A").JavaEdit("TextAreaNative$1").Exist=False
			wait 1
		Wend
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "cancel.png", True
	...
	While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaCheckBox("Seleccionar").Exist = False
		wait 1
	Wend
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaCheckBox("Seleccionar").Set "ON"
	wait 3
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"NuevoPlan.png", True
	imagenToWord "Seleecionamos nuevo plan", RutaEvidencias() &"NuevoPlan.png"
	JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaButton("Siguiente >").Click
	wait 1
	While JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaTable("(Nuevo)").Exist = False
		wait 1
	Wend
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"Resumen.png", True
	imagenToWord "Resumen de cambio de plan", RutaEvidencias() &"Resumen.png"
	JavaWindow("Ejecutivo de interacción").JavaDialog("Negociar Configuración").JavaButton("Siguiente >").Click
	wait 1
	tiempo=0
		Do
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Problema").Exist = True Then
		DataTable("s_Resultado",dtLocalSheet)="Fallido"
		DataTable("s_Detalle",dtLocalSheet)= "Mensaje de Error"
		Reporter.ReportEvent micFail, DataTable("s_Resultado",dtLocalSheet), DataTable("s_Detalle",dtLocalSheet)
	...
	imagenToWord "Calculamos monto", RutaEvidencias() &"NPC.png"
	wait 1
	...
	tiempo=0
			Do
				...
				End If
				wait 1
			Loop While Not ((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").Exist))
			wait 1
	
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").Exist=True Then
